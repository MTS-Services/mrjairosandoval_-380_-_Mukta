    ...
    <div class="drawer drawer-end">
        ...
        <div class="drawer-side">
            ...
            <ul class="menu bg-black text-[#d4a75f] min-h-full w-80 p-6">
                ...
                <a href="/"
                    class="{{ request()->routeIs('home') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Home</a>
                <a href="{{ route('f.about') }}"
                    class="{{ request()->routeIs('f.about') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">About
                    Us</a>
                <a href="{{ route('f.service') }}"
                    class="{{ request()->routeIs('f.service') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Our
                    Services</a>
                <a href="{{ route('f.memberShip') }}"
                    class="{{ request()->routeIs('f.memberShip') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Membership</a>
                <a href="{{ route('f.insight') }}"
                    class="{{ request()->routeIs('f.insight') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Insights</a>
                <a href="{{ route('f.contact') }}"
                    class="{{ request()->routeIs('f.contact') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Contact</a>
                <a href="{{ route('f.privacy-policy') }}"
                    class="{{ request()->routeIs('f.privacy-policy') ? 'text-[#caa36b] underline' : 'hover:underline' }} p-2">Privacy
                    Policy</a>
                <a href="{{ route('f.login') }}"
