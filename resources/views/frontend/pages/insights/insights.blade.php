<x-frontend::layout>
    ...
    <div class="h-screen max-w-full h-full bg-black ">
        <section class="bg-black text-white font-serif">
            <!-- Main Container -->
            <div class="max-w-7xl mx-auto px-6 py-12">
                <!-- Title -->
                <h1
                    class="pt-20 text-center text-4xl font-(family-name:--font-family-base) md:text-5xl text-[#c4a76a] font-semibold tracking-wide m-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="bg-[#111] rounded-lg overflow-hidden p-4">
                        <img src="{{ asset('frontend/assetes/image/Rectangle 1 (1).png') }}" alt="mask"
                            class="w-full h-48 object-cover">
                        <div class="p-6">
                            <p class="uppercase text-xs tracking-wider text-gray-400 mb-1 text-left">Philosophy</p>
                            <h2 class="text-xl font-semibold text-[#c4a76a] mb-2 text-left">The Art of Elegant
                                Disappearance
                            </h2>
                    ...
                    <div class="bg-[#111] rounded-lg overflow-hidden p-4">
                        ...
                        <div class="p-6">
                            ...
                            <h2 class="text-xl font-semibold text-[#c4a76a] mb-2 text-left">Generational Wealth & Secret
                                Traditions
                            </h2>
                            <p class="text-gray-300 mb-4 text-left">
                    ...
                    <!-- Card 3 -->
                    <div class="bg-[#111] rounded-lg overflow-hidden p-4">
                        <img src="{{ asset('frontend/assetes/image/Rectangle 1.png') }}" alt="modern art"
                            class="w-full h-48 object-cover">
                        <div class="p-6">
                            <p class="uppercase text-xs tracking-wider text-gray-400 mb-1 text-left">Observations</p>
                            <h2 class="text-xl font-semibold text-[#c4a76a] mb-2 text-left">Taste: When to Refuse</h2>
                            <p class="text-gray-300 mb-4 text-left">
        ...
        <section class="text-center m-20">
