    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 flex items-center justify-center px-4">
        ...
        <div class="max-w-md w-full space-y-8">
            ...
            <div class="space-y-4">
                @if (Auth::guard('admin')->check())
                    <a href="{{ url('/admin/dashboard') }}"
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Go to Admin Dashboard
                                </h2>
                    ...
                    <form method="POST" action="{{ url('/admin/logout') }}" class="block">
                        ...
                        <button type="submit"
                            ...
                            <div class="flex items-center space-x-4">
                                ...
                                <div>
                                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Logout from Admin
                                    </h2>
                ...
                @elseif(Auth::check())
                    ...
                    <a href="{{ url('user/dashboard') }}"
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div>
                                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">Go to User Dashboard
                                </h2>
                ...
                @else
                    {{-- If neither admin nor regular user is logged in --}}
                    <a href="{{ url('/login') }}"
                        class="block p-6 bg-white dark:bg-gray-800 rounded-lg shadow-sm hover:shadow-md transition-shadow duration-300 border border-gray-200 dark:border-gray-700 hover:border-blue-500 dark:hover:border-blue-400">
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-blue-100 dark:bg-blue-900 rounded-lg">
                    ...
                    <a href="{{ url('/register') }}"
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="p-3 bg-blue-100 dark:bg-blue-900 rounded-lg">
                                <i data-lucide="user-plus" class="w-6 h-6 text-blue-600 dark:text-blue-300"></i>
                                {{-- Changed icon for register --}}
                            </div>
                            <div>
