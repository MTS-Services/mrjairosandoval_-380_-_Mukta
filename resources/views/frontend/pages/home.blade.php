<x-frontend::layout>
    ...
    <section class="relative bg-black" id="hero-section">
        <img src="{{ asset('frontend/assetes/image/car2.png') }}" alt="Luxury Car" class="   object-cover">
        <div class="absolute inset-0 bg-black/50"></div>
        <div class="absolute inset-0 flex flex-col justify-center items-center text-center p-4">
            <h1 class="lg:text-6xl sm:text-4xl text-xl md:text-4xl font-bold mx-auto leading-24! max-w-6xl mx-auto">
