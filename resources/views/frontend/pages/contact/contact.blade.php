<x-frontend::layout>
    ...
    <section class="bg-black text-white font-serif  min-screen lg:w-250 mx-auto mb-20">
        <div class="text-center ">
            <!-- Heading -->
            <h1 class="text-[#caa36b] text-2xl lg:text-4xl font-(family-name:--font-family-base) font-semibold pt-30 ">
    ...
    <section class="bg-black text-white font-serif flex items-center justify-center pt-20">
        <div class="text-center max-w-2xl px-6">

            <!-- Eye Icon -->
            <div class="flex justify-center mb-6">
                <img src="image/image 81.png" alt="Eye" class="w-10 h-10">
            </div>
