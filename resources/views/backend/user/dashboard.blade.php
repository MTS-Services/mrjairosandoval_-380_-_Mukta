<x-frontend::layout>
    ...
    <div class="flex min-h-screen bg-gray-900 text-gray-300">
        ...
        <section class="flex-1 container mx-auto px-4 py-8 space-y-8">
            ...
            <!-- Welcome Section -->
            <div class="welcome-subsection flex flex-col md:flex-row md:items-center md:justify-between">
                <div>
                ...
                <div class="right-sidebar-panels space-y-6">
                    ...
                    <div class="quick-actions-panel">
                        <div class="bg-black border border-gray-700 rounded-lg p-6">
                            ...
                            <div class="space-y-3">
                                <button
                                    class="w-full border border-gray-700 text-gold py-3 px-4 rounded-lg font-medium hover:bg-gray-800 hover:text-white transition-colors">
    ...
    <!-- Sidebar toggle script for dropdowns -->
    {{-- <script>
        document.addEventListener('DOMContentLoaded', () => {
            const currentSlug = "{{ $page_slug }}";
            if(currentSlug.startsWith('create_article') || currentSlug.startsWith('list_articles')) {
                document.getElementById('articlesMenu').classList.remove('hidden');
            }
        });
    </script> --}}
</x-frontend::layout>
