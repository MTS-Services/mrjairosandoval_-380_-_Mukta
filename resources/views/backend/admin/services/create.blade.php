<x-admin::layout>
    <x-slot name="title">Create Services</x-slot>
    <x-slot name="breadcrumb">Create Services</x-slot>
  ...
  <section>
       ...
       <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('sm.service.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
