    ...
    <section>
        ...
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-center justify-between">
                <h2 class="text-xl font-bold text-text-black dark:text-text-white">{{ __('Contact Trash') }}</h2>
                <div class="flex items-center gap-2">
                 
                    <x-admin.primary-link href="{{ route('cm.contact.index') }}">{{ __('Back') }} <i data-lucide="undo-2"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const details = {
                    ...
                    displayLength: 10,
                    main_route: "{{ route('cm.contact.trash') }}",
