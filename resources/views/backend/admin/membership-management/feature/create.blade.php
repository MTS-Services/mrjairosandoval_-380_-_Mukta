<x-admin::layout>
    <x-slot name="title">{{ __('Feature Create') }}</x-slot>
    <x-slot name="breadcrumb">{{ __('Feature Create') }}</x-slot>
    ...
    <section>
        ...
        <div
            ...
            <div class="glass-card rounded-2xl p-6 md:col-span-5">
                <form action="{{ route('mm.feature.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
