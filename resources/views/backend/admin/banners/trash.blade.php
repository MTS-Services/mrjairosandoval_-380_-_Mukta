<x-admin::layout>
    <x-slot name="title">{{ __(' Banner Tresh') }}</x-slot>
    <x-slot name="breadcrumb">{{ __(' Banner Tresh') }}</x-slot>
        ...
        <div class="glass-card rounded-2xl p-6 mb-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2">
                      ...
                      <x-admin.primary-link href="{{ route('bm.banner.index') }}">{{ __('Back') }} <i data-lucide="undo-2"
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const details = {
                    ...
                    displayLength: 10,
                    main_route: "{{ route('bm.banner.trash') }}",
